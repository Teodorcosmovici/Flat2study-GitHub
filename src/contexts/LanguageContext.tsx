...
const translations = {
  en: {
    ...
    'about.teodorBio1': 'Teodor is a Romanian student studying Mathematics, Economics, and Art History at New York University.',
    'about.teodorBio2': 'Having lived around the globe, his knowledge of various markets allows him to satisfy his clients\' needs with precision, regardless of their background.',
    'about.teodorBio3': 'Outside of flat2study, Teodor is a passionate pianist and hiker.',
    ...
    'listing.propertyManagerFee': 'Property Manager Fee',
    'listing.total': 'Total',
    ...
    'listing.notIncluded': 'Not included',
    ...
    'booking.requestVisit': 'Ask for more information',
    'booking.visitRequest.title': 'Ask for More Information',
    'booking.visitRequest.description': 'Fill in your details and we will get back to you with more information.',
    'booking.visitRequest.name': 'Name',
    'booking.visitRequest.namePlaceholder': 'Enter your full name',
    'booking.visitRequest.email': 'Email',
    'booking.visitRequest.emailPlaceholder': 'Enter your email address',
    'booking.visitRequest.phone': 'Phone Number',
    'booking.visitRequest.phonePlaceholder': 'Enter your phone number',
    'booking.visitRequest.cancel': 'Cancel',
    'booking.visitRequest.submit': 'Send Request',
    'booking.visitRequest.message': 'I would like to request more information about this property.',
    'booking.visitRequest.success': 'Request sent!',
    'booking.visitRequest.successDesc': 'The landlord will contact you soon with more information.',
    'booking.visitRequest.error': 'Error',
    'booking.visitRequest.errorDesc': 'Failed to send visit request. Please try again.',
    
    // Payment Summary Modal
    'paymentSummary.title': 'Payment summary',
    'paymentSummary.whenBookingAccepted': 'When your booking is accepted',
    'paymentSummary.throughPlatform': 'Through our platform',
    'paymentSummary.firstRentalFull': 'First rental payment (full month)',
    'paymentSummary.oneTimeServiceFee': 'One-time service fee',
    'paymentSummary.propertyManagerFee': 'Property Manager Fee',
    'paymentSummary.afterBookingConfirmed': 'After booking is confirmed',
    'paymentSummary.toLandlord': 'To landlord',
    'paymentSummary.oneTimePayment': 'One-time payment',
    'paymentSummary.securityDeposit': 'Security deposit',
    'paymentSummary.landlordAdminFee': 'Landlord admin fee',
    'paymentSummary.monthlyPayments': 'Monthly payments',
    'paymentSummary.water': 'Water',
    'paymentSummary.internet': 'Internet',
    'paymentSummary.electricity': 'Electricity',
    'paymentSummary.gas': 'Gas',
    'paymentSummary.included': 'Included',
    'paymentSummary.monthlyRent': 'Monthly rent',
    'paymentSummary.alreadyPaid': '(already paid)',
    'paymentSummary.prorated': '(prorated)',
    'paymentSummary.priceMatchGuarantee': 'If you find it cheaper elsewhere, we\'ll refund the difference.',
    ...
    'landlord.features.qualityTenantsDesc': 'We check the enrollment status of students and their financial means manually so that you have one less thing to worry about.',
    'landlord.features.onlineBookings': 'Online viewings and bookings',
    'landlord.features.onlineBookingsDesc': 'If you don\'t want to do property showings, that\'s totally fine. Let us know and we will organize online viewings for interested students.',
    'landlord.features.payOnSuccess': 'Listing with us is completely free!',
    'landlord.features.payOnSuccessDesc': 'Chances are, your property will be rented out super fast. When payments go through our platform, the system only retains 2% of the total transaction. That means that 98% of the rental value goes straight into your bank account!',
    'landlord.features.personalService': 'Personalised service',
    'landlord.features.personalServiceDesc': 'Our team speaks English, Italian, French, German, Spanish, and Romanian. Don\'t hesitate to reach out with any questions you might have! We are available at all times.',
  ...
  it: {
    ...
    'about.teodorBio1': 'Teodor è uno studente rumeno che studia matematica, economia e storia dell\'arte alla New York University.',
    'about.teodorBio2': 'Avendo vissuto in diverse parti del mondo, la sua conoscenza dei vari mercati gli consente di soddisfare con precisione le esigenze dei suoi clienti, indipendentemente dal loro background.',
    'about.teodorBio3': 'Oltre al suo lavoro presso flat2study, Teodor è un appassionato pianista ed escursionista.',
    ...
    'listing.propertyManagerFee': 'Commissione Property Manager',
    ...
    'listing.notIncluded': 'Non incluso',
    ...
    'booking.requestVisit': 'Chiedi più informazioni',
    'booking.visitRequest.title': 'Chiedi Più Informazioni',
    'booking.visitRequest.description': 'Inserisci i tuoi dati e ti ricontatteremo con più informazioni.',
    'booking.visitRequest.name': 'Nome',
    'booking.visitRequest.namePlaceholder': 'Inserisci il tuo nome completo',
    'booking.visitRequest.email': 'Email',
    'booking.visitRequest.emailPlaceholder': 'Inserisci il tuo indirizzo email',
    'booking.visitRequest.phone': 'Numero di Telefono',
    'booking.visitRequest.phonePlaceholder': 'Inserisci il tuo numero di telefono',
    'booking.visitRequest.cancel': 'Annulla',
    'booking.visitRequest.submit': 'Invia Richiesta',
    'booking.visitRequest.message': 'Vorrei richiedere più informazioni su questa proprietà.',
    'booking.visitRequest.success': 'Richiesta inviata!',
    'booking.visitRequest.successDesc': 'Il proprietario ti contatterà presto con più informazioni.',
    'booking.visitRequest.error': 'Errore',
    'booking.visitRequest.errorDesc': 'Impossibile inviare la richiesta di visita. Riprova.',
    
    // Payment Summary Modal
    'paymentSummary.title': 'Riepilogo pagamenti',
    'paymentSummary.whenBookingAccepted': 'Quando la prenotazione è accettata',
    'paymentSummary.throughPlatform': 'Attraverso la nostra piattaforma',
    'paymentSummary.firstRentalFull': 'Primo pagamento affitto (mese intero)',
    'paymentSummary.oneTimeServiceFee': 'Commissione di servizio una tantum',
    'paymentSummary.propertyManagerFee': 'Commissione Property Manager',
    'paymentSummary.afterBookingConfirmed': 'Dopo conferma prenotazione',
    'paymentSummary.toLandlord': 'Al proprietario',
    'paymentSummary.oneTimePayment': 'Pagamento una tantum',
    'paymentSummary.securityDeposit': 'Deposito cauzionale',
    'paymentSummary.landlordAdminFee': 'Spese amministrative proprietario',
    'paymentSummary.monthlyPayments': 'Pagamenti mensili',
    'paymentSummary.water': 'Acqua',
    'paymentSummary.internet': 'Internet',
    'paymentSummary.electricity': 'Elettricità',
    'paymentSummary.gas': 'Gas',
    'paymentSummary.included': 'Incluso',
    'paymentSummary.monthlyRent': 'Affitto mensile',
    'paymentSummary.alreadyPaid': '(già pagato)',
    'paymentSummary.prorated': '(proporzionale)',
    'paymentSummary.priceMatchGuarantee': 'Se trovi più economico altrove, rimborseremo la differenza.',
    ...
    'landlord.features.qualityTenantsDesc': 'Controlliamo manualmente lo stato di iscrizione degli studenti e le loro risorse finanziarie in modo che tu abbia una preoccupazione in meno.',
    'landlord.features.onlineBookings': 'Visite online e prenotazioni',
    'landlord.features.onlineBookingsDesc': 'Se non vuoi fare visite alla proprietà, va benissimo. Faccelo sapere e organizzeremo visite online per gli studenti interessati.',
    'landlord.features.payOnSuccess': 'Inserire annunci con noi è completamente gratuito!',
    'landlord.features.payOnSuccessDesc': 'È probabile che la tua proprietà venga affittata molto velocemente. Quando i pagamenti passano attraverso la nostra piattaforma, il sistema trattiene solo il 2% della transazione totale. Ciò significa che il 98% del valore dell\'affitto va direttamente sul tuo conto bancario!',
    'landlord.features.personalService': 'Servizio personalizzato',
    'landlord.features.personalServiceDesc': 'Il nostro team parla inglese, italiano, francese, tedesco, spagnolo e rumeno. Non esitare a contattarci per qualsiasi domanda! Siamo disponibili in ogni momento.',
